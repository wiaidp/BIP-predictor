...
rRMSE & 0.962 & 0.967 & 0.990 & 0.967 \\ 
   \hline
\end{tabular}
\caption{Relative root mean-square error of HP-C against classic direct forecast: numbers smaller one signify an outperformance by the direct HP-C forecast.  } 
\label{f_stat}
\end{table}
