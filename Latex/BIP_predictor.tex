...
\begin{figure}[H]\begin{center}\includegraphics[height=3in, width=4.5in]{./Figures/Data.pdf}\caption{Data: standardized log-differences: pandemic trimmed to $\pm 3$.\label{data}}\end{center}\end{figure}
