...
\caption{Ragged end.  } 
\label{f_stat}
\end{table}% latex table generated in R 4.4.1 by xtable 1.8-4 package
% Thu May  8 14:00:18 2025
\begin{table}[ht]
\centering
\begin{tabular}{rrrrrr}
...
\begin{figure}[H]\begin{center}\includegraphics[height=3in, width=5in]{./Figures/up_dated_ma_inv_multi_ip.pdf}\caption{MA-inversion (impulse response) of VAR: data up to Jan-2008 (left) vs. entire data set (right).\label{up_dated_ma_inv_multi_ip}}\end{center}\end{figure}
\begin{figure}[H]\begin{center}\includegraphics[height=3in, width=5in]{./Figures/bk_2008_all.pdf}\caption{M-SSA filter tracking HP-GDP at forecast horizon $h=4$: data up to Jan-2008 (left) vs. entire data set (right).\label{bk_2008_all}}\end{center}\end{figure}
